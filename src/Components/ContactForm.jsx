...
const ContactForm = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm(
      'amiya_personalport',     // Replace with your new Service ID
      'default',    // Replace with your new Template ID or 'default'
      form.current,         // Reference to your form
      'cdoSytMf3BqCdBI3H'      // Replace with your new User ID (Public Key)
    )
    .then(
      (result) => {
